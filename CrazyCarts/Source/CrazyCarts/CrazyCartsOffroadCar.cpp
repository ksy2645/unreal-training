...
#include "CrazyCartsOffroadCar.h"
#include "CrazyCartsOffroadWheelFront.h"
#include "CrazyCartsOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

ACrazyCartsOffroadCar::ACrazyCartsOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UCrazyCartsOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UCrazyCartsOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UCrazyCartsOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UCrazyCartsOffroadWheelRear::StaticClass();
