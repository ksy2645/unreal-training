...
#include "CrazyCartsSportsCar.h"
#include "CrazyCartsSportsWheelFront.h"
#include "CrazyCartsSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ACrazyCartsSportsCar::ACrazyCartsSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UCrazyCartsSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UCrazyCartsSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UCrazyCartsSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UCrazyCartsSportsWheelRear::StaticClass();
